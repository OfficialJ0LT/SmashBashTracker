...
def apply_background(bg_type, current_game=None):
    era_bgs = {
        ...
        "Smash 4": "https://i.postimg.cc/JhBp1kt6/d6yinaf-1ebd91a9-d4d6-4a21-a28a-ddbece1be63a.webp",
        "Ultimate": "https://i.postimg.cc/XqnLc1LD/1cqbxgaxnl311.webp",
        "Complete!": "https://i.postimg.cc/bJh9pV7v/latest.webp"
    }
...
MASTER_DATA = {
    ...
    "Ultimate": ["ULT: Mario - JigglyPuff", "ULT: Peach - Ganandorf", "ULT: Mewtwo - Diddykong", "ULT: Lucas - Little Mac", "ULT: Greninja - Inkling", "ULT: Ridley - Min Min", "ULT: DLC Finale"],
}
